...
class WesternNatalRequest(BaseModel):
    """
    WesternNatalRequest
    """ # noqa: E501
    ...
    def house_system_validate_enum(cls, value):
        ...
        if value not in set(['placidus', 'koch', 'equal', 'whole_sign']):
            raise ValueError("must be one of enum values ('placidus', 'koch', 'equal', 'whole_sign')")
        return value
