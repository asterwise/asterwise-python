...
class TamilNallaNeramWindow(BaseModel):
    """
    TamilNallaNeramWindow
    """ # noqa: E501
    start: StrictStr = Field(description="Auspicious window start in HH:MM local time.")
    end: StrictStr = Field(description="Auspicious window end in HH:MM local time.")
