...
class ChaldeanRequest(BaseModel):
    """
    ChaldeanRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="Person name (BirthInput `name`)")
    var_date: date = Field(description="Birth date YYYY-MM-DD (BirthInput `date`)", alias="date")
