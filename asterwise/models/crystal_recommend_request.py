...
class CrystalRecommendRequest(BaseModel):
    """
    CrystalRecommendRequest
    """ # noqa: E501
    zodiac_sign: Optional[StrictStr] = None
    chakra: Optional[StrictStr] = None
    intention: Optional[StrictStr] = None
    limit: Optional[Annotated[int, Field(le=20, strict=True, ge=1)]] = Field(default=5, description="Maximum number of recommendations to return.")
    __properties: ClassVar[List[str]] = ["zodiac_sign", "chakra", "intention", "limit"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if zodiac_sign (nullable) is None
        # and model_fields_set contains the field
        if self.zodiac_sign is None and "zodiac_sign" in self.model_fields_set:
            _dict['zodiac_sign'] = None

        # set to None if chakra (nullable) is None
        # and model_fields_set contains the field
        if self.chakra is None and "chakra" in self.model_fields_set:
            _dict['chakra'] = None
