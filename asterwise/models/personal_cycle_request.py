...
class PersonalCycleRequest(BaseModel):
    ...
    """ # noqa: E501
    var_date: date = Field(description="Birth date", alias="date")
    year: Optional[StrictInt] = None
    month: Optional[Annotated[int, Field(le=12, strict=True, ge=1)]] = None
    day: Optional[Annotated[int, Field(le=31, strict=True, ge=1)]] = None
    __properties: ClassVar[List[str]] = ["date", "year", "month", "day"]
