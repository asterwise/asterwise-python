...
class YesNoRequest(BaseModel):
    ...
    YesNoRequest
    """ # noqa: E501
    allow_reversed: Optional[StrictBool] = Field(default=True, description="If true, reversed cards return 'maybe' instead of their base yes/no answer.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allow_reversed": obj.get("allow_reversed") if obj.get("allow_reversed") is not None else True,
