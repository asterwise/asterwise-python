...
class FestivalCalendarResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in festivals (list)
        _items = []
        if self.festivals:
            for _item_festivals in self.festivals:
                if _item_festivals:
                    _items.append(_item_festivals.to_dict())
            _dict['festivals'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "festivals": [FestivalEntry.from_dict(_item) for _item in obj["festivals"]] if obj.get("festivals") is not None else None
        })
        return _obj
