...
class CalendarRahuKaal(BaseModel):
    """
    CalendarRahuKaal
    """ # noqa: E501
    start: StrictStr = Field(description="Rahu Kaal start time in HH:MM local time.")
    end: StrictStr = Field(description="Rahu Kaal end time in HH:MM local time.")
