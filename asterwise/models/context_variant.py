...
class ContextVariant(BaseModel):
    ...
    ContextVariant
    """ # noqa: E501
    context: StrictStr = Field(description="The specific dream context or variant.")
    meaning: StrictStr = Field(description="The interpretation for this specific context.")
    __properties: ClassVar[List[str]] = ["context", "meaning"]
