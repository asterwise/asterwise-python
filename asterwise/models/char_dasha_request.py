...
class CharDashaRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["location", "name", "date", "time", "latitude", "longitude", "timezone", "ayanamsa", "cycles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cycles": obj.get("cycles") if obj.get("cycles") is not None else 1
        })
        return _obj
