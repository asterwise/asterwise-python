...
class DreamSymbolListResponse(BaseModel):
    """
    DreamSymbolListResponse
    """ # noqa: E501
    total: StrictInt = Field(description="Total number of symbols returned.")
    category_filter: Optional[StrictStr] = None
    symbols: List[DreamSymbol] = Field(description="Dream symbols sorted alphabetically.")
    __properties: ClassVar[List[str]] = ["total", "category_filter", "symbols"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if category_filter (nullable) is None
        # and model_fields_set contains the field
        if self.category_filter is None and "category_filter" in self.model_fields_set:
            _dict['category_filter'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "symbols": [DreamSymbol.from_dict(_item) for _item in obj["symbols"]] if obj.get("symbols") is not None else None
        })
        return _obj
