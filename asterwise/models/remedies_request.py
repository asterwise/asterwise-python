...
class RemediesRequest(BaseModel):
    ...
    top_n: Optional[Annotated[int, Field(le=9, strict=True, ge=1)]] = Field(default=5, description="Max planets to prescribe remedies for (1-9)")
    __properties: ClassVar[List[str]] = ["location", "name", "date", "time", "latitude", "longitude", "timezone", "ayanamsa", "top_n"]
