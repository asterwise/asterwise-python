...
class CalendarYoga(BaseModel):
    """
    CalendarYoga
    """ # noqa: E501
    name: StrictStr = Field(description="Yoga name.")
    index: StrictInt = Field(description="Zero-based yoga index, 0 to 26.")
    is_inauspicious: StrictBool = Field(description="True if this yoga is inauspicious.")
    end_time: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "index", "is_inauspicious", "end_time"]
