...
class PlanetaryReturnRequest(BaseModel):
    """
    ...
    planet: StrictStr = Field(description="Planet name for the return chart")
    after_date: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["location", "name", "date", "time", "latitude", "longitude", "timezone", "ayanamsa", "planet", "after_date"]
