...
class YogaData(BaseModel):
    ...
    YogaData
    """ # noqa: E501
    index: StrictInt = Field(description="Zero-based yoga index, 0 to 26")
    name: StrictStr = Field(description="Yoga name, e.g. Vishkumbha, Shiva")
    is_inauspicious: StrictBool = Field(description="True if this yoga is considered inauspicious")
    degrees_elapsed: Union[StrictFloat, StrictInt] = Field(description="Degrees completed within the current yoga")
    end_time: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["index", "name", "is_inauspicious", "degrees_elapsed", "end_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "is_inauspicious": obj.get("is_inauspicious"),
