...
class YoginiPeriod(BaseModel):
    ...
    YoginiPeriod
    """ # noqa: E501
    yogini: StrictStr = Field(description="Name of the Yogini ruling this period, e.g. Mangala, Pingala, Dhanya")
    planet: StrictStr = Field(description="Planetary lord of this Yogini")
