...
class CrystalListResponse(BaseModel):
    ...
    CrystalListResponse
    """ # noqa: E501
    total: StrictInt = Field(description="Total number of crystals in the database.")
    crystals: List[CrystalEntry] = Field(description="All crystals sorted alphabetically.")
    __properties: ClassVar[List[str]] = ["total", "crystals"]
