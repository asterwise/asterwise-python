...
class WesternAspectsRequest(BaseModel):
    """
    WesternAspectsRequest
    """ # noqa: E501
    positions: Dict[str, Union[StrictFloat, StrictInt]] = Field(description="Dictionary of body name to tropical ecliptic longitude (0-360). Example: {\"Sun\": 229.6, \"Moon\": 221.8, \"Mars\": 189.6}")
    orbs: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = None
    __properties: ClassVar[List[str]] = ["positions", "orbs"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if orbs (nullable) is None
        # and model_fields_set contains the field
        if self.orbs is None and "orbs" in self.model_fields_set:
            _dict['orbs'] = None
