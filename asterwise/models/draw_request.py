...
class DrawRequest(BaseModel):
    ...
    DrawRequest
    """ # noqa: E501
    count: Optional[Annotated[int, Field(le=78, strict=True, ge=1)]] = Field(default=1, description="Number of cards to draw (1-78). Default: 1.")
    ...
    __properties: ClassVar[List[str]] = ["count", "allow_reversed"]
