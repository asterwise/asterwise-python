...
class AppApiResponseApiResponseCompatibilityResponse1(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": AppApiSchemasWesternCompatibilityResponse.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
