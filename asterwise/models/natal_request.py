...
class NatalRequest(BaseModel):
    ...
    include_interpretation: Optional[StrictBool] = Field(default=False, description="Whether to include planet-in-house interpretation layer")
    __properties: ClassVar[List[str]] = ["location", "name", "date", "time", "latitude", "longitude", "timezone", "ayanamsa", "include_interpretation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "include_interpretation": obj.get("include_interpretation") if obj.get("include_interpretation") is not None else False
        })
        return _obj
