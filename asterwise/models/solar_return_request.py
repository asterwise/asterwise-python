...
class SolarReturnRequest(BaseModel):
    ...
    year: StrictInt = Field(description="Year for the solar return (e.g. 2026)")
    __properties: ClassVar[List[str]] = ["location", "name", "date", "time", "latitude", "longitude", "timezone", "ayanamsa", "year"]
