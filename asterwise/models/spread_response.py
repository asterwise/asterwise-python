...
class SpreadResponse(BaseModel):
    ...
    SpreadResponse
    """ # noqa: E501
    spread_type: StrictStr = Field(description="Spread type: 'three_card' or 'celtic_cross'")
    positions: List[DrawnCardSchema]
    question: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["spread_type", "positions", "question"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spread_type": obj.get("spread_type"),
            "positions": [DrawnCardSchema.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None,
