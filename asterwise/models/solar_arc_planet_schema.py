...
class SolarArcPlanetSchema(BaseModel):
    """
    SolarArcPlanetSchema
    """ # noqa: E501
    name: StrictStr
    natal_longitude: Union[StrictFloat, StrictInt]
    directed_longitude: Union[StrictFloat, StrictInt]
    sign: StrictStr
    sign_index: StrictInt
    degree_in_sign: Union[StrictFloat, StrictInt]
    dignity: StrictStr
    dignity_score: StrictInt
    __properties: ClassVar[List[str]] = ["name", "natal_longitude", "directed_longitude", "sign", "sign_index", "degree_in_sign", "dignity", "dignity_score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "directed_longitude": obj.get("directed_longitude"),
            "sign": obj.get("sign"),
