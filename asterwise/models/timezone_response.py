...
class TimezoneResponse(BaseModel):
    ...
    TimezoneResponse
    """ # noqa: E501
    latitude: Union[StrictFloat, StrictInt] = Field(description="Input latitude.")
    longitude: Union[StrictFloat, StrictInt] = Field(description="Input longitude.")
    timezone: StrictStr = Field(description="IANA timezone identifier.")
    __properties: ClassVar[List[str]] = ["latitude", "longitude", "timezone"]
