...
class NatalCrystalResponse(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of natal_context
        if self.natal_context:
            _dict['natal_context'] = self.natal_context.to_dict()
