...
class LuckyNumbersApiResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["lucky_numbers", "power_number", "date_specific", "interpretation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "power_number": obj.get("power_number"),
            "date_specific": obj.get("date_specific") if obj.get("date_specific") is not None else False,
