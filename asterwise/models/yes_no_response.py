...
class YesNoResponse(BaseModel):
    ...
    answer: StrictStr = Field(description="'yes', 'no', or 'maybe'")
    confidence: StrictStr = Field(description="'strong' = card directly says yes/no. 'leaning' = reversed card. 'unclear' = maybe card.")
    question: Optional[StrictStr] = None
    active_meaning: StrictStr
    __properties: ClassVar[List[str]] = ["card", "is_reversed", "answer", "confidence", "question", "active_meaning"]
