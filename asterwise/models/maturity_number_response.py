...
class MaturityNumberResponse(BaseModel):
    """
    MaturityNumberResponse
    """ # noqa: E501
    maturity_number: StrictInt
    life_path_number: StrictInt
    expression_number: StrictInt
    is_master_number: StrictBool
    __properties: ClassVar[List[str]] = ["maturity_number", "life_path_number", "expression_number", "is_master_number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maturity_number": obj.get("maturity_number"),
            "life_path_number": obj.get("life_path_number"),
            "expression_number": obj.get("expression_number"),
