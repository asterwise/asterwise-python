...
class WesternModalities(BaseModel):
    """
    WesternModalities
    """ # noqa: E501
    cardinal: StrictInt
    fixed: StrictInt
    mutable: StrictInt
    dominant: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["cardinal", "fixed", "mutable", "dominant"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if dominant (nullable) is None
        # and model_fields_set contains the field
        if self.dominant is None and "dominant" in self.model_fields_set:
            _dict['dominant'] = None
