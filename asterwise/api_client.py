...
from asterwise.api_response import ApiResponse, T as ApiResponseT
import asterwise.models
from asterwise import rest
from asterwise.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/0.2.0-dev/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(asterwise.models, klass)
