...
class LalKitabApi:
    ...
    def lal_kitab_chart(
        self,
        lal_kitab_request: LalKitabRequest,
        ...
        _param = self._lal_kitab_chart_serialize(
            lal_kitab_request=lal_kitab_request,
    ...
    @validate_call
    def lal_kitab_chart_with_http_info(
        self,
        lal_kitab_request: LalKitabRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def lal_kitab_chart_without_preload_content(
        self,
        lal_kitab_request: LalKitabRequest,
        _request_timeout: Union[
            None,
    ...
    def _lal_kitab_chart_serialize(
        self,
        lal_kitab_request,
        _request_auth,
        _content_type,
        ...
        if lal_kitab_request is not None:
            _body_params = lal_kitab_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/astro/lal-kitab/chart',
    ...
    def lal_kitab_remedies(
        ...
        _param = self._lal_kitab_remedies_serialize(
            lal_kitab_request=lal_kitab_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def lal_kitab_remedies_with_http_info(
        self,
        lal_kitab_request: LalKitabRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def lal_kitab_remedies_without_preload_content(
        self,
        lal_kitab_request: LalKitabRequest,
        _request_timeout: Union[
            None,
    ...
    def _lal_kitab_remedies_serialize(
        self,
        lal_kitab_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/astro/lal-kitab/remedies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
