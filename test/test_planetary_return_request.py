...
class TestPlanetaryReturnRequest(unittest.TestCase):
    """PlanetaryReturnRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlanetaryReturnRequest:
        """Test PlanetaryReturnRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlanetaryReturnRequest`
        """
        model = PlanetaryReturnRequest()
        if include_optional:
            return PlanetaryReturnRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testPlanetaryReturnRequest(self):
        """Test PlanetaryReturnRequest"""
