...
class TestCalendarNakshatra(unittest.TestCase):
    """CalendarNakshatra unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarNakshatra:
        """Test CalendarNakshatra
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarNakshatra`
        """
        model = CalendarNakshatra()
        if include_optional:
            return CalendarNakshatra(
                name = '',
                index = 56,
                pada = 56,
                end_time = ''
    ...
    def testCalendarNakshatra(self):
        """Test CalendarNakshatra"""
