...
class TestChartRequest(unittest.TestCase):
    """ChartRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartRequest:
        """Test ChartRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartRequest`
        """
        model = ChartRequest()
        if include_optional:
            return ChartRequest(
