...
class TestWesternAspectsResponse(unittest.TestCase):
    """WesternAspectsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternAspectsResponse:
        """Test WesternAspectsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternAspectsResponse`
        """
        model = WesternAspectsResponse()
        if include_optional:
            return WesternAspectsResponse(
                aspects = [
    ...
    def testWesternAspectsResponse(self):
        """Test WesternAspectsResponse"""
