...
class TestAtmakarakaRequest(unittest.TestCase):
    """AtmakarakaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AtmakarakaRequest:
        """Test AtmakarakaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AtmakarakaRequest`
        """
        model = AtmakarakaRequest()
        if include_optional:
            return AtmakarakaRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testAtmakarakaRequest(self):
        """Test AtmakarakaRequest"""
