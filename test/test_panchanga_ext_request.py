...
class TestPanchangaExtRequest(unittest.TestCase):
    """PanchangaExtRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PanchangaExtRequest:
        """Test PanchangaExtRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PanchangaExtRequest`
        """
        model = PanchangaExtRequest()
        if include_optional:
            return PanchangaExtRequest(
                var_date = '',
                location = '',
                latitude = -90.0,
                longitude = -180.0,
    ...
    def testPanchangaExtRequest(self):
        """Test PanchangaExtRequest"""
