...
class TestNatalCrystalEntry(unittest.TestCase):
    """NatalCrystalEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NatalCrystalEntry:
        """Test NatalCrystalEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NatalCrystalEntry`
        """
        model = NatalCrystalEntry()
        if include_optional:
            return NatalCrystalEntry(
                slug = '',
                name = '',
                colors = [
                    ''
    ...
    def testNatalCrystalEntry(self):
        """Test NatalCrystalEntry"""
