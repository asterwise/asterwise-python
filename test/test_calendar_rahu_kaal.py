...
class TestCalendarRahuKaal(unittest.TestCase):
    """CalendarRahuKaal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarRahuKaal:
        """Test CalendarRahuKaal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarRahuKaal`
        """
        model = CalendarRahuKaal()
        if include_optional:
            return CalendarRahuKaal(
                start = '',
                end = ''
            )
        else:
