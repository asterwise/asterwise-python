...
class TestMaturityNumberResponse(unittest.TestCase):
    """MaturityNumberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaturityNumberResponse:
        """Test MaturityNumberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaturityNumberResponse`
        """
        model = MaturityNumberResponse()
        if include_optional:
            return MaturityNumberResponse(
                maturity_number = 56,
                life_path_number = 56,
    ...
    def testMaturityNumberResponse(self):
        """Test MaturityNumberResponse"""
