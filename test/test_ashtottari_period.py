...
class TestAshtottariPeriod(unittest.TestCase):
    """AshtottariPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AshtottariPeriod:
        """Test AshtottariPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AshtottariPeriod`
        """
        model = AshtottariPeriod()
        if include_optional:
