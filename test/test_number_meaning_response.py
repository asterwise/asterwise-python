...
class TestNumberMeaningResponse(unittest.TestCase):
    """NumberMeaningResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumberMeaningResponse:
        """Test NumberMeaningResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumberMeaningResponse`
        """
        model = NumberMeaningResponse()
        if include_optional:
    ...
    def testNumberMeaningResponse(self):
        """Test NumberMeaningResponse"""
