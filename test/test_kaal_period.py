...
class TestKaalPeriod(unittest.TestCase):
    """KaalPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KaalPeriod:
        """Test KaalPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KaalPeriod`
        """
        model = KaalPeriod()
        if include_optional:
            return KaalPeriod(
