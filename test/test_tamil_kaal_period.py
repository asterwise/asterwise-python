...
class TestTamilKaalPeriod(unittest.TestCase):
    """TamilKaalPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TamilKaalPeriod:
        """Test TamilKaalPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TamilKaalPeriod`
        """
        model = TamilKaalPeriod()
        if include_optional:
            return TamilKaalPeriod(
                start = '',
                end = '',
                duration_minutes = 56,
                is_active = True
