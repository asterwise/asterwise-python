...
class TestMaturityNumberRequest(unittest.TestCase):
    """MaturityNumberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaturityNumberRequest:
        """Test MaturityNumberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaturityNumberRequest`
        """
        model = MaturityNumberRequest()
        if include_optional:
            return MaturityNumberRequest(
                name = '0',
    ...
    def testMaturityNumberRequest(self):
        """Test MaturityNumberRequest"""
