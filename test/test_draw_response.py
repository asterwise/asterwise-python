...
class TestDrawResponse(unittest.TestCase):
    """DrawResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DrawResponse:
        """Test DrawResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DrawResponse`
        """
        model = DrawResponse()
        if include_optional:
            return DrawResponse(
