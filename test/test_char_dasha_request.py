...
class TestCharDashaRequest(unittest.TestCase):
    """CharDashaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharDashaRequest:
        """Test CharDashaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharDashaRequest`
        """
        model = CharDashaRequest()
        if include_optional:
            return CharDashaRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
