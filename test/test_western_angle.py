...
class TestWesternAngle(unittest.TestCase):
    """WesternAngle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternAngle:
        """Test WesternAngle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternAngle`
        """
        model = WesternAngle()
        if include_optional:
            return WesternAngle(
