...
class TestSadeSatiResponse(unittest.TestCase):
    """SadeSatiResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SadeSatiResponse:
        """Test SadeSatiResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SadeSatiResponse`
        """
        model = SadeSatiResponse()
        if include_optional:
