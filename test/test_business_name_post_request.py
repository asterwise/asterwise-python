...
class TestBusinessNamePostRequest(unittest.TestCase):
    """BusinessNamePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessNamePostRequest:
        """Test BusinessNamePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessNamePostRequest`
        """
        model = BusinessNamePostRequest()
        if include_optional:
            return BusinessNamePostRequest(
                name = '0'
            )
        else:
            return BusinessNamePostRequest(
    ...
    def testBusinessNamePostRequest(self):
        """Test BusinessNamePostRequest"""
