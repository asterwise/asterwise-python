...
class TestWesternElements(unittest.TestCase):
    """WesternElements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternElements:
        """Test WesternElements
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternElements`
        """
        model = WesternElements()
        if include_optional:
            return WesternElements(
                fire = 56,
                earth = 56,
                air = 56,
                water = 56,
