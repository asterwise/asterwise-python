...
class TestPersonalCycleResponse(unittest.TestCase):
    """PersonalCycleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalCycleResponse:
        """Test PersonalCycleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalCycleResponse`
        """
        model = PersonalCycleResponse()
        if include_optional:
            return PersonalCycleResponse(
                personal_year = 56,
                personal_month = 56,
                personal_day = 56,
                target_year = 56,
    ...
    def testPersonalCycleResponse(self):
        """Test PersonalCycleResponse"""
