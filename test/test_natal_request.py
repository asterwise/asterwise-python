...
class TestNatalRequest(unittest.TestCase):
    """NatalRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NatalRequest:
        """Test NatalRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NatalRequest`
        """
        model = NatalRequest()
        if include_optional:
            return NatalRequest(
