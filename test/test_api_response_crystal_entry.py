...
class TestApiResponseCrystalEntry(unittest.TestCase):
    """ApiResponseCrystalEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseCrystalEntry:
        """Test ApiResponseCrystalEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseCrystalEntry`
        """
        model = ApiResponseCrystalEntry()
        if include_optional:
            return ApiResponseCrystalEntry(
                success = True,
                message = 'success',
                data = asterwise.models.crystal_entry.CrystalEntry(
                    slug = '', 
                    name = '', 
                    colors = [
                        ''
    ...
    def testApiResponseCrystalEntry(self):
        """Test ApiResponseCrystalEntry"""
