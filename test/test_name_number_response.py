...
class TestNameNumberResponse(unittest.TestCase):
    """NameNumberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NameNumberResponse:
        """Test NameNumberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NameNumberResponse`
        """
        model = NameNumberResponse()
        if include_optional:
    ...
    def testNameNumberResponse(self):
        """Test NameNumberResponse"""
