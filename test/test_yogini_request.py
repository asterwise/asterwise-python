...
class TestYoginiRequest(unittest.TestCase):
    """YoginiRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YoginiRequest:
        """Test YoginiRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YoginiRequest`
        """
        model = YoginiRequest()
        if include_optional:
            return YoginiRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
