...
class TestYogaRequest(unittest.TestCase):
    """YogaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YogaRequest:
        """Test YogaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YogaRequest`
        """
        model = YogaRequest()
        if include_optional:
            return YogaRequest(
