...
class TestAshtottariResponse(unittest.TestCase):
    """AshtottariResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AshtottariResponse:
        """Test AshtottariResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AshtottariResponse`
        """
        model = AshtottariResponse()
        if include_optional:
            return AshtottariResponse(
                root = [
    ...
    def testAshtottariResponse(self):
        """Test AshtottariResponse"""
