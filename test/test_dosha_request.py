...
class TestDoshaRequest(unittest.TestCase):
    """DoshaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoshaRequest:
        """Test DoshaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoshaRequest`
        """
        model = DoshaRequest()
        if include_optional:
            return DoshaRequest(
