...
class TestSpreadResponse(unittest.TestCase):
    """SpreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpreadResponse:
        """Test SpreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpreadResponse`
        """
        model = SpreadResponse()
        if include_optional:
