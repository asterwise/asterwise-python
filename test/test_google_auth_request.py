...
class TestGoogleAuthRequest(unittest.TestCase):
    """GoogleAuthRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GoogleAuthRequest:
        """Test GoogleAuthRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GoogleAuthRequest`
        """
    ...
    def testGoogleAuthRequest(self):
        """Test GoogleAuthRequest"""
