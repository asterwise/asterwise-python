...
class TestTarotCardSchema(unittest.TestCase):
    """TarotCardSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TarotCardSchema:
        """Test TarotCardSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TarotCardSchema`
        """
        model = TarotCardSchema()
        if include_optional:
            return TarotCardSchema(
                id = '',
                name = '',
                arcana_type = '',
                suit = '',
