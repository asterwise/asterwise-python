...
class TestHoraPeriod(unittest.TestCase):
    """HoraPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HoraPeriod:
        """Test HoraPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HoraPeriod`
        """
        model = HoraPeriod()
        if include_optional:
            return HoraPeriod(
