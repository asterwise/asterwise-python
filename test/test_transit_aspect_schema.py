...
class TestTransitAspectSchema(unittest.TestCase):
    """TransitAspectSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransitAspectSchema:
        """Test TransitAspectSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransitAspectSchema`
        """
        model = TransitAspectSchema()
        if include_optional:
            return TransitAspectSchema(
                transit_planet = '',
                natal_planet = '',
                type = '',
                exact_angle = 1.337,
    ...
    def testTransitAspectSchema(self):
        """Test TransitAspectSchema"""
