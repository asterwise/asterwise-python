...
class TestCrystalRecommendRequest(unittest.TestCase):
    """CrystalRecommendRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CrystalRecommendRequest:
        """Test CrystalRecommendRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrystalRecommendRequest`
        """
        model = CrystalRecommendRequest()
        if include_optional:
            return CrystalRecommendRequest(
                zodiac_sign = '',
                chakra = '',
                intention = '',
                limit = 1.0
    ...
    def testCrystalRecommendRequest(self):
        """Test CrystalRecommendRequest"""
