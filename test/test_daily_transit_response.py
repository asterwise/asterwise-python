...
class TestDailyTransitResponse(unittest.TestCase):
    """DailyTransitResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DailyTransitResponse:
        """Test DailyTransitResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DailyTransitResponse`
        """
        model = DailyTransitResponse()
        if include_optional:
    ...
    def testDailyTransitResponse(self):
        """Test DailyTransitResponse"""
