...
class TestChaldeanRequest(unittest.TestCase):
    """ChaldeanRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChaldeanRequest:
        """Test ChaldeanRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChaldeanRequest`
        """
        model = ChaldeanRequest()
        if include_optional:
            return ChaldeanRequest(
                name = '0',
