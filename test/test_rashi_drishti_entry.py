...
class TestRashiDrishtiEntry(unittest.TestCase):
    """RashiDrishtiEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RashiDrishtiEntry:
        """Test RashiDrishtiEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RashiDrishtiEntry`
        """
        model = RashiDrishtiEntry()
        if include_optional:
            return RashiDrishtiEntry(
                from_sign = '',
                from_sign_num = 56,
                to_sign = '',
                to_sign_num = 56
    ...
    def testRashiDrishtiEntry(self):
        """Test RashiDrishtiEntry"""
