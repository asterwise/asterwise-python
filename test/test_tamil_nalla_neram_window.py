...
class TestTamilNallaNeramWindow(unittest.TestCase):
    """TamilNallaNeramWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TamilNallaNeramWindow:
        """Test TamilNallaNeramWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TamilNallaNeramWindow`
        """
        model = TamilNallaNeramWindow()
        if include_optional:
            return TamilNallaNeramWindow(
                start = '',
                end = ''
            )
        else:
    ...
    def testTamilNallaNeramWindow(self):
        """Test TamilNallaNeramWindow"""
