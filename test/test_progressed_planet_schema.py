...
class TestProgressedPlanetSchema(unittest.TestCase):
    """ProgressedPlanetSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgressedPlanetSchema:
        """Test ProgressedPlanetSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgressedPlanetSchema`
        """
        model = ProgressedPlanetSchema()
        if include_optional:
            return ProgressedPlanetSchema(
                name = '',
                longitude = 1.337,
                sign = '',
                sign_index = 56,
    ...
    def testProgressedPlanetSchema(self):
        """Test ProgressedPlanetSchema"""
