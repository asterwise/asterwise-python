...
class TestYogaData(unittest.TestCase):
    """YogaData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YogaData:
        """Test YogaData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YogaData`
        """
        model = YogaData()
        if include_optional:
            return YogaData(
