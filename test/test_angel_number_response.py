...
class TestAngelNumberResponse(unittest.TestCase):
    """AngelNumberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AngelNumberResponse:
        """Test AngelNumberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AngelNumberResponse`
        """
        model = AngelNumberResponse()
        if include_optional:
            return AngelNumberResponse(
                number = '',
                theme = '',
                message = '',
                guidance = '',
    ...
    def testAngelNumberResponse(self):
        """Test AngelNumberResponse"""
