...
class TestCalendarYoga(unittest.TestCase):
    """CalendarYoga unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarYoga:
        """Test CalendarYoga
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarYoga`
        """
        model = CalendarYoga()
        if include_optional:
            return CalendarYoga(
