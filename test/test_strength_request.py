...
class TestStrengthRequest(unittest.TestCase):
    """StrengthRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StrengthRequest:
        """Test StrengthRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StrengthRequest`
        """
        model = StrengthRequest()
        if include_optional:
            return StrengthRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
