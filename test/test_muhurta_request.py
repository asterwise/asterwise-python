...
class TestMuhurtaRequest(unittest.TestCase):
    """MuhurtaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MuhurtaRequest:
        """Test MuhurtaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MuhurtaRequest`
        """
        model = MuhurtaRequest()
        if include_optional:
            return MuhurtaRequest(
                event_type = '',
                from_date = '',
                to_date = '',
                latitude = 1.337,
