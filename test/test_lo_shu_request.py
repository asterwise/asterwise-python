...
class TestLoShuRequest(unittest.TestCase):
    """LoShuRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoShuRequest:
        """Test LoShuRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoShuRequest`
        """
        model = LoShuRequest()
        if include_optional:
            return LoShuRequest(
