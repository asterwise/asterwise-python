...
class TestApiResponseListDashaPeriod(unittest.TestCase):
    """ApiResponseListDashaPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseListDashaPeriod:
        """Test ApiResponseListDashaPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseListDashaPeriod`
        """
        model = ApiResponseListDashaPeriod()
        if include_optional:
            return ApiResponseListDashaPeriod(
                success = True,
                message = 'success',
                data = [
    ...
    def testApiResponseListDashaPeriod(self):
        """Test ApiResponseListDashaPeriod"""
