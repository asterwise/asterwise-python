...
class TestTodayAngelNumberResponse(unittest.TestCase):
    """TodayAngelNumberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TodayAngelNumberResponse:
        """Test TodayAngelNumberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TodayAngelNumberResponse`
        """
        model = TodayAngelNumberResponse()
        if include_optional:
            return TodayAngelNumberResponse(
                number = '',
                theme = '',
                message = '',
                guidance = '',
    ...
    def testTodayAngelNumberResponse(self):
        """Test TodayAngelNumberResponse"""
