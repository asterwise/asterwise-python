...
class TestYogaResult(unittest.TestCase):
    """YogaResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YogaResult:
        """Test YogaResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YogaResult`
        """
        model = YogaResult()
        if include_optional:
            return YogaResult(
