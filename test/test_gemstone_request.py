...
class TestGemstoneRequest(unittest.TestCase):
    """GemstoneRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GemstoneRequest:
        """Test GemstoneRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GemstoneRequest`
        """
        model = GemstoneRequest()
        if include_optional:
