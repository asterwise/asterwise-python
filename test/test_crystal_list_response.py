...
class TestCrystalListResponse(unittest.TestCase):
    """CrystalListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CrystalListResponse:
        """Test CrystalListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CrystalListResponse`
        """
        model = CrystalListResponse()
        if include_optional:
    ...
    def testCrystalListResponse(self):
        """Test CrystalListResponse"""
