...
class TestWesternAspect(unittest.TestCase):
    """WesternAspect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternAspect:
        """Test WesternAspect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternAspect`
        """
        model = WesternAspect()
        if include_optional:
