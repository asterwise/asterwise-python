...
class TestDoshaResult(unittest.TestCase):
    """DoshaResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DoshaResult:
        """Test DoshaResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DoshaResult`
        """
        model = DoshaResult()
        if include_optional:
            return DoshaResult(
