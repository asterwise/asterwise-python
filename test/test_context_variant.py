...
class TestContextVariant(unittest.TestCase):
    """ContextVariant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContextVariant:
        """Test ContextVariant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContextVariant`
        """
        model = ContextVariant()
        if include_optional:
