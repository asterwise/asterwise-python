...
class TestWesternModalities(unittest.TestCase):
    """WesternModalities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternModalities:
        """Test WesternModalities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternModalities`
        """
        model = WesternModalities()
        if include_optional:
            return WesternModalities(
                cardinal = 56,
                fixed = 56,
                mutable = 56,
                dominant = ''
    ...
    def testWesternModalities(self):
        """Test WesternModalities"""
