...
class TestWesternHemisphere(unittest.TestCase):
    """WesternHemisphere unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternHemisphere:
        """Test WesternHemisphere
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternHemisphere`
        """
        model = WesternHemisphere()
        if include_optional:
    ...
    def testWesternHemisphere(self):
        """Test WesternHemisphere"""
