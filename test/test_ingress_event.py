...
class TestIngressEvent(unittest.TestCase):
    """IngressEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IngressEvent:
        """Test IngressEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IngressEvent`
        """
        model = IngressEvent()
        if include_optional:
            return IngressEvent(
