...
class TestDashaRequest(unittest.TestCase):
    """DashaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashaRequest:
        """Test DashaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashaRequest`
        """
        model = DashaRequest()
        if include_optional:
            return DashaRequest(
