...
class TestDivisionalRequest(unittest.TestCase):
    """DivisionalRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DivisionalRequest:
        """Test DivisionalRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DivisionalRequest`
        """
        model = DivisionalRequest()
        if include_optional:
            return DivisionalRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testDivisionalRequest(self):
        """Test DivisionalRequest"""
