...
class TestWesternTransitRequest(unittest.TestCase):
    """WesternTransitRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternTransitRequest:
        """Test WesternTransitRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternTransitRequest`
        """
        model = WesternTransitRequest()
        if include_optional:
            return WesternTransitRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testWesternTransitRequest(self):
        """Test WesternTransitRequest"""
