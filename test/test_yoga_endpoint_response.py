...
class TestYogaEndpointResponse(unittest.TestCase):
    """YogaEndpointResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YogaEndpointResponse:
        """Test YogaEndpointResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YogaEndpointResponse`
        """
        model = YogaEndpointResponse()
        if include_optional:
            return YogaEndpointResponse(
                yogas = [
    ...
    def testYogaEndpointResponse(self):
        """Test YogaEndpointResponse"""
