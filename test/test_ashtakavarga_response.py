...
class TestAshtakavargaResponse(unittest.TestCase):
    """AshtakavargaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AshtakavargaResponse:
        """Test AshtakavargaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AshtakavargaResponse`
        """
        model = AshtakavargaResponse()
        if include_optional:
    ...
    def testAshtakavargaResponse(self):
        """Test AshtakavargaResponse"""
