...
class TestBiorhythmRequest(unittest.TestCase):
    """BiorhythmRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BiorhythmRequest:
        """Test BiorhythmRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BiorhythmRequest`
        """
        model = BiorhythmRequest()
        if include_optional:
            return BiorhythmRequest(
