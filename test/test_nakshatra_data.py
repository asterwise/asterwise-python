...
class TestNakshatraData(unittest.TestCase):
    """NakshatraData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NakshatraData:
        """Test NakshatraData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NakshatraData`
        """
        model = NakshatraData()
        if include_optional:
