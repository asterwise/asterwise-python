...
class TestCalendarVara(unittest.TestCase):
    """CalendarVara unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarVara:
        """Test CalendarVara
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarVara`
        """
        model = CalendarVara()
        if include_optional:
            return CalendarVara(
