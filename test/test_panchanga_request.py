...
class TestPanchangaRequest(unittest.TestCase):
    """PanchangaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PanchangaRequest:
        """Test PanchangaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PanchangaRequest`
        """
        model = PanchangaRequest()
        if include_optional:
            return PanchangaRequest(
                location = '',
                name = '',
                var_date = '',
                time = '',
