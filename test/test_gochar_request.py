...
class TestGocharRequest(unittest.TestCase):
    """GocharRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GocharRequest:
        """Test GocharRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GocharRequest`
        """
        model = GocharRequest()
        if include_optional:
            return GocharRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
