...
class TestKPBirthRequest(unittest.TestCase):
    """KPBirthRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KPBirthRequest:
        """Test KPBirthRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KPBirthRequest`
        """
        model = KPBirthRequest()
        if include_optional:
            return KPBirthRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
