...
class TestPersonalCycleRequest(unittest.TestCase):
    """PersonalCycleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalCycleRequest:
        """Test PersonalCycleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalCycleRequest`
        """
        model = PersonalCycleRequest()
        if include_optional:
            return PersonalCycleRequest(
    ...
    def testPersonalCycleRequest(self):
        """Test PersonalCycleRequest"""
