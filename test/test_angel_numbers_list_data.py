...
class TestAngelNumbersListData(unittest.TestCase):
    """AngelNumbersListData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AngelNumbersListData:
        """Test AngelNumbersListData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AngelNumbersListData`
        """
        model = AngelNumbersListData()
        if include_optional:
            return AngelNumbersListData(
                count = 56,
                numbers = [
                    ''
                    ],
    ...
    def testAngelNumbersListData(self):
        """Test AngelNumbersListData"""
