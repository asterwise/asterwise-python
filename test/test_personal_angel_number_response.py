...
class TestPersonalAngelNumberResponse(unittest.TestCase):
    """PersonalAngelNumberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalAngelNumberResponse:
        """Test PersonalAngelNumberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalAngelNumberResponse`
        """
        model = PersonalAngelNumberResponse()
        if include_optional:
            return PersonalAngelNumberResponse(
                number = '',
                theme = '',
                message = '',
                guidance = '',
    ...
    def testPersonalAngelNumberResponse(self):
        """Test PersonalAngelNumberResponse"""
