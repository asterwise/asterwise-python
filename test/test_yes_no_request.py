...
class TestYesNoRequest(unittest.TestCase):
    """YesNoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YesNoRequest:
        """Test YesNoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YesNoRequest`
        """
        model = YesNoRequest()
        if include_optional:
            return YesNoRequest(
