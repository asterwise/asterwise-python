...
class TestAshtottariRequest(unittest.TestCase):
    """AshtottariRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AshtottariRequest:
        """Test AshtottariRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AshtottariRequest`
        """
        model = AshtottariRequest()
        if include_optional:
            return AshtottariRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testAshtottariRequest(self):
        """Test AshtottariRequest"""
