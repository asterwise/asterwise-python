...
class TestRemediesRequest(unittest.TestCase):
    """RemediesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediesRequest:
        """Test RemediesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediesRequest`
        """
        model = RemediesRequest()
        if include_optional:
