...
class TestPersonalYear(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PersonalYear:
        """Test PersonalYear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalYear`
        """
        model = PersonalYear()
        if include_optional:
            return PersonalYear(
