...
class TestSpreadRequest(unittest.TestCase):
    """SpreadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpreadRequest:
        """Test SpreadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpreadRequest`
        """
        model = SpreadRequest()
        if include_optional:
