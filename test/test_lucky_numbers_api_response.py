...
class TestLuckyNumbersApiResponse(unittest.TestCase):
    """LuckyNumbersApiResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LuckyNumbersApiResponse:
        """Test LuckyNumbersApiResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LuckyNumbersApiResponse`
        """
        model = LuckyNumbersApiResponse()
        if include_optional:
            return LuckyNumbersApiResponse(
                lucky_numbers = [
                    56
                    ],
                power_number = 56,
    ...
    def testLuckyNumbersApiResponse(self):
        """Test LuckyNumbersApiResponse"""
