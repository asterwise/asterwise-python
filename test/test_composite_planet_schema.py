...
class TestCompositePlanetSchema(unittest.TestCase):
    """CompositePlanetSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompositePlanetSchema:
        """Test CompositePlanetSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompositePlanetSchema`
        """
        model = CompositePlanetSchema()
        if include_optional:
            return CompositePlanetSchema(
                name = '',
                longitude = 1.337,
                sign = '',
                sign_index = 56,
    ...
    def testCompositePlanetSchema(self):
        """Test CompositePlanetSchema"""
