...
class TestCalendarKarana(unittest.TestCase):
    """CalendarKarana unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarKarana:
        """Test CalendarKarana
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarKarana`
        """
        model = CalendarKarana()
        if include_optional:
            return CalendarKarana(
                name = '',
                number = 56,
                end_time = ''
            )
