...
class TestTransitsResponse(unittest.TestCase):
    """TransitsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransitsResponse:
        """Test TransitsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransitsResponse`
        """
        model = TransitsResponse()
        if include_optional:
