...
class TestBirthInput(unittest.TestCase):
    """BirthInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BirthInput:
        """Test BirthInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BirthInput`
        """
        model = BirthInput()
        if include_optional:
            return BirthInput(
