...
class TestChoghadiyaPeriod(unittest.TestCase):
    """ChoghadiyaPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChoghadiyaPeriod:
        """Test ChoghadiyaPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChoghadiyaPeriod`
        """
        model = ChoghadiyaPeriod()
        if include_optional:
