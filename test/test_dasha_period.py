...
class TestDashaPeriod(unittest.TestCase):
    """DashaPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashaPeriod:
        """Test DashaPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashaPeriod`
        """
        model = DashaPeriod()
        if include_optional:
            return DashaPeriod(
