...
class TestYoginiPeriod(unittest.TestCase):
    """YoginiPeriod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YoginiPeriod:
        """Test YoginiPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YoginiPeriod`
        """
        model = YoginiPeriod()
        if include_optional:
            return YoginiPeriod(
