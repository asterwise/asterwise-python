...
class TestFestivalCalendarResponse(unittest.TestCase):
    """FestivalCalendarResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FestivalCalendarResponse:
        """Test FestivalCalendarResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FestivalCalendarResponse`
        """
        model = FestivalCalendarResponse()
        if include_optional:
    ...
    def testFestivalCalendarResponse(self):
        """Test FestivalCalendarResponse"""
