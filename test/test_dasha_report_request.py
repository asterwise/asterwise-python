...
class TestDashaReportRequest(unittest.TestCase):
    """DashaReportRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashaReportRequest:
        """Test DashaReportRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashaReportRequest`
        """
        model = DashaReportRequest()
        if include_optional:
            return DashaReportRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testDashaReportRequest(self):
        """Test DashaReportRequest"""
