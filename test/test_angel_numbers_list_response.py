...
class TestAngelNumbersListResponse(unittest.TestCase):
    """AngelNumbersListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AngelNumbersListResponse:
        """Test AngelNumbersListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AngelNumbersListResponse`
        """
        model = AngelNumbersListResponse()
        if include_optional:
            return AngelNumbersListResponse(
                success = True,
                message = '',
                data = asterwise.models.angel_numbers_list_data.AngelNumbersListData(
                    count = 56, 
                    numbers = [
                        ''
                        ], 
    ...
    def testAngelNumbersListResponse(self):
        """Test AngelNumbersListResponse"""
