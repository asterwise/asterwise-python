...
class TestPanchangaCalendarPostBody(unittest.TestCase):
    """PanchangaCalendarPostBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PanchangaCalendarPostBody:
        """Test PanchangaCalendarPostBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PanchangaCalendarPostBody`
        """
        model = PanchangaCalendarPostBody()
        if include_optional:
            return PanchangaCalendarPostBody(
                year = 1900.0,
                month = 1.0,
                lat = -90.0,
                lon = -180.0,
    ...
    def testPanchangaCalendarPostBody(self):
        """Test PanchangaCalendarPostBody"""
