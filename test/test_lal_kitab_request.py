...
class TestLalKitabRequest(unittest.TestCase):
    """LalKitabRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LalKitabRequest:
        """Test LalKitabRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LalKitabRequest`
        """
        model = LalKitabRequest()
        if include_optional:
            return LalKitabRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
