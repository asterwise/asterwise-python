...
class TestAshtakavargaRequest(unittest.TestCase):
    """AshtakavargaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AshtakavargaRequest:
        """Test AshtakavargaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AshtakavargaRequest`
        """
        model = AshtakavargaRequest()
        if include_optional:
            return AshtakavargaRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testAshtakavargaRequest(self):
        """Test AshtakavargaRequest"""
