...
class TestPersonalYearResponse(unittest.TestCase):
    """PersonalYearResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalYearResponse:
        """Test PersonalYearResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalYearResponse`
        """
        model = PersonalYearResponse()
        if include_optional:
            return PersonalYearResponse(
                year = 56,
    ...
    def testPersonalYearResponse(self):
        """Test PersonalYearResponse"""
