...
class TestDreamSymbol(unittest.TestCase):
    """DreamSymbol unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DreamSymbol:
        """Test DreamSymbol
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DreamSymbol`
        """
        model = DreamSymbol()
        if include_optional:
            return DreamSymbol(
