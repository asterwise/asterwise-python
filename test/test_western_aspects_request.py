...
class TestWesternAspectsRequest(unittest.TestCase):
    """WesternAspectsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternAspectsRequest:
        """Test WesternAspectsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternAspectsRequest`
        """
        model = WesternAspectsRequest()
        if include_optional:
            return WesternAspectsRequest(
                positions = {
                    'key' : 1.337
                    },
                orbs = {
    ...
    def testWesternAspectsRequest(self):
        """Test WesternAspectsRequest"""
