...
class TestTithiData(unittest.TestCase):
    """TithiData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TithiData:
        """Test TithiData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TithiData`
        """
        model = TithiData()
        if include_optional:
            return TithiData(
