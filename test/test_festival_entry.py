...
class TestFestivalEntry(unittest.TestCase):
    """FestivalEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FestivalEntry:
        """Test FestivalEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FestivalEntry`
        """
        model = FestivalEntry()
        if include_optional:
