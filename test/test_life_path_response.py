...
class TestLifePathResponse(unittest.TestCase):
    """LifePathResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LifePathResponse:
        """Test LifePathResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LifePathResponse`
        """
        model = LifePathResponse()
        if include_optional:
            return LifePathResponse(
                life_path_number = 56,
