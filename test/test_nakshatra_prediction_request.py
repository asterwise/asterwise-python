...
class TestNakshatraPredictionRequest(unittest.TestCase):
    """NakshatraPredictionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NakshatraPredictionRequest:
        """Test NakshatraPredictionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NakshatraPredictionRequest`
        """
        model = NakshatraPredictionRequest()
        if include_optional:
            return NakshatraPredictionRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testNakshatraPredictionRequest(self):
        """Test NakshatraPredictionRequest"""
