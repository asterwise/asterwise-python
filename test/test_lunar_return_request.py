...
class TestLunarReturnRequest(unittest.TestCase):
    """LunarReturnRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LunarReturnRequest:
        """Test LunarReturnRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LunarReturnRequest`
        """
        model = LunarReturnRequest()
        if include_optional:
            return LunarReturnRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testLunarReturnRequest(self):
        """Test LunarReturnRequest"""
