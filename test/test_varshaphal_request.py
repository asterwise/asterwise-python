...
class TestVarshaphalRequest(unittest.TestCase):
    """VarshaphalRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VarshaphalRequest:
        """Test VarshaphalRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VarshaphalRequest`
        """
        model = VarshaphalRequest()
        if include_optional:
            return VarshaphalRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testVarshaphalRequest(self):
        """Test VarshaphalRequest"""
