...
class TestCompatibilityResponse(unittest.TestCase):
    """CompatibilityResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompatibilityResponse:
        """Test CompatibilityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompatibilityResponse`
        """
    ...
    def testCompatibilityResponse(self):
        """Test CompatibilityResponse"""
