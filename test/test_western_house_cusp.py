...
class TestWesternHouseCusp(unittest.TestCase):
    """WesternHouseCusp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternHouseCusp:
        """Test WesternHouseCusp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternHouseCusp`
        """
        model = WesternHouseCusp()
        if include_optional:
            return WesternHouseCusp(
                house = 1.0,
