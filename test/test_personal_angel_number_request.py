...
class TestPersonalAngelNumberRequest(unittest.TestCase):
    """PersonalAngelNumberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalAngelNumberRequest:
        """Test PersonalAngelNumberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalAngelNumberRequest`
        """
        model = PersonalAngelNumberRequest()
        if include_optional:
            return PersonalAngelNumberRequest(
                var_date = '',
                name = ''
            )
        else:
    ...
    def testPersonalAngelNumberRequest(self):
        """Test PersonalAngelNumberRequest"""
