...
class TestTransitsRequest(unittest.TestCase):
    """TransitsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransitsRequest:
        """Test TransitsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransitsRequest`
        """
        model = TransitsRequest()
        if include_optional:
            return TransitsRequest(
                from_date = '',
                to_date = ''
            )
        else:
