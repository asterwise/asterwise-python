...
class TestWesternNatalRequest(unittest.TestCase):
    """WesternNatalRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WesternNatalRequest:
        """Test WesternNatalRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WesternNatalRequest`
        """
        model = WesternNatalRequest()
        if include_optional:
            return WesternNatalRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testWesternNatalRequest(self):
        """Test WesternNatalRequest"""
