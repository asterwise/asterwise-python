...
class TestDashaTransitsRequest(unittest.TestCase):
    """DashaTransitsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DashaTransitsRequest:
        """Test DashaTransitsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DashaTransitsRequest`
        """
        model = DashaTransitsRequest()
        if include_optional:
            return DashaTransitsRequest(
                location = '',
                name = 'Chart',
                var_date = '',
                time = '',
    ...
    def testDashaTransitsRequest(self):
        """Test DashaTransitsRequest"""
