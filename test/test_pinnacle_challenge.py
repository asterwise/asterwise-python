...
class TestPinnacleChallenge(unittest.TestCase):
    """PinnacleChallenge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PinnacleChallenge:
        """Test PinnacleChallenge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PinnacleChallenge`
        """
        model = PinnacleChallenge()
        if include_optional:
            return PinnacleChallenge(
                number = 56,
                start_age = 56,
                end_age = 56,
                interpretation = '',
    ...
    def testPinnacleChallenge(self):
        """Test PinnacleChallenge"""
