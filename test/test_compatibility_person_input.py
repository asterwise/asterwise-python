...
class TestCompatibilityPersonInput(unittest.TestCase):
    """CompatibilityPersonInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompatibilityPersonInput:
        """Test CompatibilityPersonInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompatibilityPersonInput`
        """
        model = CompatibilityPersonInput()
        if include_optional:
    ...
    def testCompatibilityPersonInput(self):
        """Test CompatibilityPersonInput"""
