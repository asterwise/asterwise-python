...
class TestVaraData(unittest.TestCase):
    """VaraData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VaraData:
        """Test VaraData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VaraData`
        """
        model = VaraData()
        if include_optional:
            return VaraData(
